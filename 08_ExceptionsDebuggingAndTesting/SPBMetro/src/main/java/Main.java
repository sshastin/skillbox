...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (; ; ) {
            try {
                ...
                errorLogger.error("Exception thrown: " + e.toString());
            }
        }
    }
    ...
    private static Station takeStation(String message) throws StationNotFoundException {
        for (; ; ) {
            System.out.println(message);
            String line = scanner.nextLine().trim();
            Station station = stationIndex.getStation(line);
            infoLogger.info("Поиск станции: " + line);
            if (station != null) {
                return station;
            }
            ...
            throw new StationNotFoundException("NO SUCH STATION: " + line);
        }
    }
